...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    socials: [
      ...
      { type: 'website', url: 'https://fu11shoot.com', label: 'Website' },
    ],
    status: 'active',
  },
  {
    slug: 'cldrn',
    name: 'cldrn',
    email: 'cldrn@ch0wn3rs.ninja',
    avatarUrl: 'https://avatars.githubusercontent.com/u/208521807?v=4',
    fallbackIcon: 'ph-globe',
    bio: 'Focused on web challenges.',
    specialties: ['Web'],
    joinDate: '2026-02-15',
    joinDateLabel: 'February 2026',
    socials: [
      { type: 'github', url: 'https://avatars.githubusercontent.com/u/208521807?v=4', label: 'GitHub' },
      { type: 'email', url: 'mailto:cldrn@ch0wn3rs.ninja', label: 'Email' },
      { type: 'linkedin', url: 'https://www.linkedin.com/in/samcald3ron/', label: 'LinkedIn' },
    ],
    status: 'active',
  },
];
